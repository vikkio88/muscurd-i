...
public class MasterPasswordTests
{
    ...
    {
        var result = Assert.Throws<MasterPasswordException>(() => MasterPassword.Make("nope-yeah-1234"));
    ...
    {
        var result = Assert.Throws<MasterPasswordException>(() => MasterPassword.Make("nope-yeah-yeah-mammam-1234"));
    ...
    {
        var result = Assert.Throws<MasterPasswordException>(() => MasterPassword.Make("nope-yeah-yeah-mamm-juve"));
    ...
    {
        var result = Assert.Throws<MasterPasswordException>(() => MasterPassword.Make(new() { "nopety", "yeah", "yoyo" }, "mamm", 9999));
    ...
    {
        var result = Assert.Throws<MasterPasswordException>(() => MasterPassword.Make(new() { "nope", "yeah", "yoyo" }, "mam", 9999));
        Assert.Contains("words", result.Message);
    }
    ...
    {
        var result = Assert.Throws<MasterPasswordException>(() => MasterPassword.Make(new() { "nope", "yeah", "yoyo" }, "mammamia", 999));
        Assert.Contains("appendix", result.Message);
    }
}
